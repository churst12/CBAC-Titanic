...
classifier.fit(clean_train_data.drop("Survived", axis=1).values,
               clean_train_data["Survived"].values)
print("Model accuracy: ", classifier.score(clean_train_data.drop("Survived", axis=1).values,
                                           clean_train_data["Survived"].values))
